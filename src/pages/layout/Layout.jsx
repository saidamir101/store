      ...
      <footer className="px-[8%] py-[5%] text-[18px] font-semibold text-white bg-[#222222]">
       <div className="md:flex border-b-2 pb-[2%] border-[gray] justify-between">
        ...
        <div className="flex flex-col gap-5">
          <p className="text-[16px] text-[grey]">Телефоны справочной службы</p>
          <ul className="flex flex-col gap-5">
            <li className=" hover:text-[#FEBD1F] hover:cursor-pointer">900</li>
            <li className=" hover:text-[#FEBD1F] hover:cursor-pointer">+992 48-888-1111</li>
            <li className=" hover:text-[#FEBD1F] hover:cursor-pointer">@alifshop_tj</li>
          </ul>
        </div>
        <ul className="flex flex-col gap-5">
            <li className=" hover:text-[#FEBD1F] hover:cursor-pointer">Каталог товаров</li>
            <li className=" hover:text-[#FEBD1F] hover:cursor-pointer">Смартфоны</li>
            <li className=" hover:text-[#FEBD1F] hover:cursor-pointer">Телевизоры</li>
          </ul>
          <ul className="flex flex-col gap-5">
            <li className=" hover:text-[#FEBD1F] hover:cursor-pointer">Стиральные машины</li>
            <li className=" hover:text-[#FEBD1F] hover:cursor-pointer">Кондиционеры</li>
          </ul>
          <div className="flex flex-col gap-5">
        ...
        <div className="flex justify-between pt-[3%] ">
          <p className="text-[10px] md:text-[15px] text-[grey]">© 2023 ОАО «Алиф Банк». г. Душанбе, 101 мкр-н, ул. Багаутдинова, 9</p>
